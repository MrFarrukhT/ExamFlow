...
app.get('/test', async (req, res) => {
    try {
        ...
        // Classify the error so an admin checking the launcher status can
        // distinguish "Neon is cold-starting" from "wrong password" without
        // reading the server logs. Never expose the full error message.
        let reason = 'unknown';
...
app.post('/submissions', submissionLimiter, async (req, res) => {
    try {
        ...
        // Catches cheaters who backdate or forward-date submissions (year 2050/9999/1970)
        // to manipulate dashboard chronology. 5min forward skew + 24h backdate window.
