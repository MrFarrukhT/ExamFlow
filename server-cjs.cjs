...
// IDOR by design — matches "no student auth, controlled by invigilator" pattern
// ============================================
...
// Get answer keys for a mock + skill (student-facing, requires prior submission for THIS mock)
app.get('/my-answer-keys', submissionLimiter, async (req, res) => {
    try {
        ...
        // (mock-scoped — prevents viewing Mock 2 keys after only submitting Mock 1)
